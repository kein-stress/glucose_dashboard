...
const translations = {
  ru: {
    ...
    'error.INVALID_PASSWORD': 'Неверный пароль',
  ...
  es: {
    ...
    'error.UNAUTHORIZED': 'Se requiere autorización',
    'error.RATE_LIMITED': 'Demasiados intentos de inicio de sesión, inténtalo más tarde',
  },
  de: {
    'app.title': 'Glucose × Workout Dashboard',
    ...
    'error.INVALID_PASSWORD': 'Falsches Passwort',
    'error.UNAUTHORIZED': 'Autorisierung erforderlich',
    'error.RATE_LIMITED': 'Zu viele Anmeldeversuche, versuche es später erneut',
  },
  fr: {
    'app.title': 'Glucose × Workout Dashboard',
    ...
    'error.UNAUTHORIZED': 'Autorisation requise',
    'error.RATE_LIMITED': 'Trop de tentatives de connexion, réessaie plus tard',
  },
};
